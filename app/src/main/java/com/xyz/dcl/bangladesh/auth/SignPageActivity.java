package com.xyz.dcl.bangladesh.auth;
...
import com.xyz.dcl.bangladesh.DCASHMainActivity;
...
public class SignPageActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v == btnSignInSelection){
            ...
            btnSignUpSelection.setTextColor(getResources().getColor(R.color.white_transparent));
            ...
            btnSignInSelection.setTextColor(getResources().getColor(R.color.white_transparent));
