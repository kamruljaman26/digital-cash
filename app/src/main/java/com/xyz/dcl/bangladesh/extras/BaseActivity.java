package com.xyz.dcl.bangladesh.extras;
...
import com.xyz.dcl.bangladesh.auth.SignPageActivity;
...
public class BaseActivity extends LocalizationActivity {
    ...
    public void logout(Context context) {
        ...
        Intent intent = new Intent(getApplicationContext(), SignPageActivity.class);
