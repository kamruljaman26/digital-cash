package com.xyz.dcl.bangladesh.shared_pref;
...
public class UserPref {
    ...
    private static final String USER_EARNING_BALANCE = "earning_balance";
     ...
     * @param eBalance
     */
    public void setUserEarningBalance(String eBalance) {
        editor.putString(USER_EARNING_BALANCE, eBalance);
        editor.apply();
    }
     ...
     * @param @null
     */
    public String getUserEarningBalance() {
        return sharedPreferences.getString(USER_EARNING_BALANCE, "");
    }
